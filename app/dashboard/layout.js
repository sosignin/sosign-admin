                    ...
                    {sidebarOpen ? (
                        <div className="relative flex items-center">
                            ...
                            <input
                                ...
                                className="w-full pl-9 pr-8 py-2 text-sm bg-gray-100/80 hover:bg-gray-100 focus:bg-white text-gray-700 placeholder-gray-400 rounded-xl border border-transparent focus:border-blue-400 focus:ring-2 focus:ring-blue-100 transition-all duration-200 outline-none"
                            />
                            {searchQuery && (
                                <button
                                    onClick={() => setSearchQuery("")}
                                    className="absolute right-2.5 w-5 h-5 flex items-center justify-center rounded-full text-gray-400 hover:text-gray-600 hover:bg-gray-200 transition-colors text-xs"
                                    title="Clear search"
                                >
                        ...
                        <button
                            ...
                            className="w-full py-2 flex items-center justify-center rounded-xl bg-gray-100 text-gray-500 hover:bg-blue-50 hover:text-blue-600 transition-colors"
                            title="Search menu"
                        >
                    ...
                    {filteredNavItems.length > 0 ? (
                        ...
                        sidebarOpen && (
                            <div className="py-8 text-center text-gray-400">
                                <i className="fas fa-search text-2xl mb-2 block opacity-40"></i>
